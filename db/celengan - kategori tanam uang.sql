...
--
-- Host: localhost:3306
-- Generation Time: Dec 07, 2023 at 11:04 PM
...
(5, 15, '20000.00', 'TESTING', 0, 'Transfer', '2023-12-03', 'pemasukan');
...
INSERT INTO `transac_kategori` (`id`, `name`, `tipe`, `deleted`) VALUES
(1, 'Makanan', 'pengeluaran', 0),
(2, 'Minuman', 'pengeluaran', 0),
(3, 'Transportasi', 'pengeluaran', 0),
(4, 'Pajak', 'pengeluaran', 0),
(5, 'Pulsa', 'pengeluaran', 0),
(6, 'Tagihan', 'pengeluaran', 0),
(7, 'Gaji', 'pemasukan', 0),
(8, 'Investasi', 'pemasukan', 0),
(9, 'Penjualan', 'pemasukan', 0),
(10, 'Deposito', 'pemasukan', 0),
(11, 'Penyewaan', 'pemasukan', 0),
(12, 'Tabungan', 'pemasukan', 0);
...
(15, 'Revo', '972e762737e769b7766e05294dfbd9aaecb500a0adb65698caa0a9f6cd38537a', '2023-12-07 22:51:58', 1, 'OZaI6', '3e6961d825a5c60a2be1d5bc07932ea280129500d502c97d09af890b3079016a');
